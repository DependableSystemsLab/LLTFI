...
bin/                  Python driver scripts (instrument, profile, injectfault, …)
tools/                Trace analysis tools, FIDL, GenerateMakefile, …
...
- `protobuf-3.17.2/`, `protobuf-all-3.17.2.zip` — downloaded dependency, not part of the repo
