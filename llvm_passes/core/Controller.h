...
enum FIInstSelMethod { insttype, funcname, sourcecode, custominstselector };

enum FIRegSelMethod { regloc, customregselector };

enum FIRegLoc { dstreg, allreg, allsrcreg, srcreg1, srcreg2, srcreg3, srcreg4 };
...
public:
  void getFIInstRegsMap(std::map<Instruction*, std::list<int>*>** fiinstreg) {
