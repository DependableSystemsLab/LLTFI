...
int main(int argc, char *argv[]) {
  ...
  FaultInjectorManager *faultinjectormanager =
      FaultInjectorManager::getFaultInjectorManager();
  vector<string> hardwarefaultinjectornames =
      faultinjectormanager->getInjectorNamesForType(string("HardwareFault"));
