...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp t5-decoder-with-lm-head-12.onnx
