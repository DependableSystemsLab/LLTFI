...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp googlenet-12.onnx
mlir-translate -mlir-to-llvmir googlenet-12.onnx.mlir > model.mlir.ll
