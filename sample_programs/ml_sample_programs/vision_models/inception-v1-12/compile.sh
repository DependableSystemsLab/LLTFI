...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp inception-v1-12.onnx
mlir-translate -mlir-to-llvmir inception-v1-12.onnx.mlir > model.mlir.ll
