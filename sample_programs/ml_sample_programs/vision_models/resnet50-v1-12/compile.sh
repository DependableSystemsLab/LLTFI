...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp resnet50-v1-12.onnx
mlir-translate -mlir-to-llvmir resnet50-v1-12.onnx.mlir > model.mlir.ll
