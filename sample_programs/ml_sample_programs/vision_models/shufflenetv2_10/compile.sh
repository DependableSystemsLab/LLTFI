...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp shufflenet-v2-10.onnx
mlir-translate -mlir-to-llvmir shufflenet-v2-10.onnx.mlir > model.mlir.ll
