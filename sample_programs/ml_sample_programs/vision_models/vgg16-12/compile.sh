...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp vgg16-12.onnx
mlir-translate -mlir-to-llvmir vgg16-12.onnx.mlir > model.mlir.ll
