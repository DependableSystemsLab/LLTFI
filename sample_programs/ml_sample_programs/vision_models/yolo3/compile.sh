...
onnx-mlir --EmitLLVMIR  --instrument-stage=Onnx --instrument-ops=onnx.* --InstrumentBeforeOp --InstrumentAfterOp --InstrumentBeforeAndAfterOp yolov3-10.onnx
mlir-translate -mlir-to-llvmir yolov3-10.onnx.mlir > model.mlir.ll
