...
#define SAD_TYPE_IX(n, image_size)                                             \
  ((n == 1)                                                                    \
       ? SAD_TYPE_1_IX(image_size)                                             \
       : ((n == 2)                                                             \
              ? SAD_TYPE_2_IX(image_size)                                      \
              : ((n == 3)                                                      \
                     ? SAD_TYPE_3_IX(image_size)                               \
                     : ((n == 4)                                               \
                            ? SAD_TYPE_4_IX(image_size)                        \
                            : ((n == 5)                                        \
                                   ? SAD_TYPE_5_IX(image_size)                 \
                                   : ((n == 6)                                 \
                                          ? SAD_TYPE_6_IX(image_size)          \
...
void sad4_cpu(unsigned short *blk_sad, unsigned short *frame,
              unsigned short *ref, int mb_width, int mb_height);
