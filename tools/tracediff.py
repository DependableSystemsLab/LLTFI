...
if __name__ == "__main__":
    if len(sys.argv) >= 2 and (sys.argv[1] == "-h" or sys.argv[1] == "--help"):
        print(
            (
                "%(prog)s compares the golden program trace and fault injection program trace and summarizes the differences\n\n"
                "running option: %(prog)s <golden output> <faulty output>"
                % {"prog": prog}
            ),
            file=sys.stderr,
        )
