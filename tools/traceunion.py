...
if __name__ == "__main__":
    if len(sys.argv) >= 2 and (sys.argv[1] == "-h" or sys.argv[1] == "--help"):
        print(
            (
                "%(prog)s takes more than one input program trace difference summary file and combines them to one report\n\n"
        ...
        print(
            "Error: running option: %(prog)s file1 file2 ..." % {"prog": prog},
            file=sys.stderr,
        )
        sys.exit(1)
